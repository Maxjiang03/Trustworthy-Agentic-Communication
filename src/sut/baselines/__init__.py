...
`CapabilityDecisionPath` -- and every arm is a configuration of one of them,
declared as data (the SS E.5 bitmask, plus the ADR 0029 ladder attributes on
the OAuth family). What an arm overrides is what its SS E.1 row says it does
