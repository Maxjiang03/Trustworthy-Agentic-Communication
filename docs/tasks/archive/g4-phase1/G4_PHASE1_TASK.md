...
launch prompt**. If either differs, the file is truncated or altered — **STOP and report**, do
not act on a partial spec.
...
`[UNVERIFIED-IA]`. Archive this spec under `docs/tasks/archive/g4-phase1/` with the standing
