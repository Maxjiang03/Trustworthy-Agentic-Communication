...
prompt**. If either differs, **STOP and report**. Confirm the `pre-commit` git hook is installed,
...
`docs/tasks/archive/exp7-subcases-and-heldout/` with the standing note that task specs are
