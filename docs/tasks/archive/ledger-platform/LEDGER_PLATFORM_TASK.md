...
3. Archive this file byte-for-byte to `docs/tasks/archive/ledger-platform/` with a `MANIFEST.md` carrying its SHA-256 and the standard label **"retrospective records — NOT pre-registration evidence."** Remove the root copy in the same commit.
