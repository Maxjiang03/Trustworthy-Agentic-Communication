...
Create `docs/workplan/archive/g1/` and place **byte-for-byte, unmodified** copies of:

- `SMOKE_G1_TASK.md`
- `SMOKE_G1_RESOLUTION_TASK.md`
- this file, `SMOKE_G1_CORRECTIVE_TASK.md`

Record the **SHA-256 of each** in `docs/workplan/archive/g1/MANIFEST.md`, with this header at the top of that file:
...
5. `docs: archive g1 task specifications as retrospective records` — `docs/workplan/archive/g1/` + `MANIFEST.md`
