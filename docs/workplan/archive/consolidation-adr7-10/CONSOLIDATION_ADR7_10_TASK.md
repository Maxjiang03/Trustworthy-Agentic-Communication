...
Create `docs/workplan/archive/consolidation-adr7-10/`, copy this file byte-for-byte, add `MANIFEST.md` with its SHA-256 and the standard label **"retrospective records — NOT pre-registration evidence."** Remove the root working copy in the same commit.
